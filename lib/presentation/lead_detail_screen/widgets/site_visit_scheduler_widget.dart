...
class __ScheduleBottomSheetContentState
  ...
  final TextEditingController _propertyCtrl = TextEditingController();
  bool _isSaving = false;

  @override
  void initState() {
    super.initState();
    _propertyCtrl.text = widget.defaultProperty;
  }
  ...
  Future<void> _schedule() async {
    ...
    final visit = SiteVisitModel(
      ...
      property: _propertyCtrl.text.trim().isEmpty
          ? widget.defaultProperty
